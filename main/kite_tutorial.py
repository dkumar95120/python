...
""" PART 0: BEFORE WE START ====================================================
    ...
    Look for the 𝕜𝕚𝕥𝕖 indiciator in the bottom right corner of VS Code's status
...
# 1c. Snippets
#
# Kite uses VS Code's native snippets functionality to help you complete
...
obj = {'foo': 'bar', 'baz': 'qux'}
ensure_ascii = True
output = json.dumps(obj, ensure_ascii=ensure_ascii)  # <--
