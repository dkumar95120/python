...
from collections.abc import (Set, Container, Sized, Iterable, Sequence)
...
class TestSequenceProtocol (unittest.TestCase):
	...
	def test_concatenate_overlapping(self):
		s = SortedSet([1,2,3])
		t = SortedSet([3,4,5])
	...
	def test_repetition_rzero(self):
		s = SortedSet([1,2,3])
		self.assertEqual(0 * s, SortedSet())

	def test_repetition_rnonzero(self):
		s = SortedSet([1,2,3])
