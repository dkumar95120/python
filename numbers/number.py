...
departure = datetime(year=2019, month=11, day=9,
                     hour=23, minute=30, tzinfo=pst)
arrival = datetime(year=2019, month=11, day=10, hour=18,
                   minute=15, tzinfo=timezone.utc)
